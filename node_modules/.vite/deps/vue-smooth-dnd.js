    ...
    !function(e, t) {
          ...
          if (null === o2) {
            if (null !== n2) {
              if (!m2) {
                ...
                if (a2 < l2 + r2) {
                  (m2 = window.document.createElement("div")).className = h + " " + g2().orientation;
      ...
      function Et(e2) {
        ...
        return function(e3) {
          ...
          var v2 = Number.MAX_SAFE_INTEGER, h2 = o2;
          if (h2 === r2 && h2++, h2 < x2.length) {
            var y2 = E2.getSize(x2[h2]);
            if (f2 = E2.getBeginEnd(x2[h2]), i2 < y2) {
              var b2 = (y2 - i2) / 2;
              v2 = f2.begin + b2;
            } else v2 = f2.begin;
            d2 = f2.begin;
...
var vue_smooth_dnd_esm_exports = {};
__export(vue_smooth_dnd_esm_exports, {
  Container: () => Container,
  Draggable: () => Draggable
});
var import_smooth_dnd = __toESM(require_dist());
__reExport(vue_smooth_dnd_esm_exports, __toESM(require_dist()));
...
var Container = {
  ...
  mounted: function mounted() {
    ...
    this.container = (0, import_smooth_dnd.smoothDnD)(this.containerElement, mapOptions(this));
  },
  updated: function updated() {
    if (this.$refs.container !== this.containerElement && this.$el !== this.containerElement) {
      if (this.container) {
...
var wrapChild = function(createElement, ctx) {
  var tagProps = getTagProps(ctx, import_smooth_dnd.constants.wrapperClass);
  return createElement(
    tagProps.value,
...
//# sourceMappingURL=vue-smooth-dnd.js.map
