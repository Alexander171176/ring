...
function useDrag(params) {
  ...
  const eventDrag = (event, nodeEl) => {
    ...
    if (!dragStarted) {
      ...
      dragAborted = distance2 >= 0.5 && distance2 < nodeDragThreshold.value;
    }
...
function useHandle({
  ...
  function handleClick(event) {
    ...
    if (!connectionClickStartHandle.value) {
      ...
      startConnection({ nodeId: toValue(nodeId), type: toValue(type), handleId: toValue(handleId) }, void 0, true);
    } else {
      let isValidConnectionHandler = toValue(isValidConnection) || isValidConnectionProp.value || alwaysValid;
      const node = findNode(toValue(nodeId));
      if (!isValidConnectionHandler && node) {
...
var _sfc_main$a = defineComponent({
  ...
  setup(__props) {
    ...
    function onPointerDown(event) {
      ...
      (_b = container.value) == null ? void 0 : _b.setPointerCapture(event.pointerId);
      ...
      for (const [id2, edge] of edgeLookup.value) {
        edgeIdLookup.value.set(edge.source, ((_c = edgeIdLookup.value.get(edge.source)) == null ? void 0 : _c.add(id2)) || /* @__PURE__ */ new Set([id2]));
        edgeIdLookup.value.set(edge.target, ((_d = edgeIdLookup.value.get(edge.target)) == null ? void 0 : _d.add(id2)) || /* @__PURE__ */ new Set([id2]));
      }
      removeSelectedElements();
    ...
    function onPointerUp(event) {
      ...
      (_a = container.value) == null ? void 0 : _a.releasePointerCapture(event.pointerId);
...
//# sourceMappingURL=chunk-ZRBFXUEG.js.map
