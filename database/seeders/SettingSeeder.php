...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                'type' => 'number',
                'option' => 'AdminCountPages',
                'value' => '20',
                'constant' => 'ADMIN_COUNT_PAGES',
                'category' => 'admin',
                'description' => 'Показывать количество Страниц в таблице Панели Администратора',
                'activity' => true,
                'sort' => 0,
            ],
            [
                'type' => 'string',
                'option' => 'AdminSortPages',
                'value' => 'id',
                'constant' => 'ADMIN_SORT_PAGES',
                'category' => 'admin',
                'description' => 'Сортировка по полю у Страниц по умолчанию в таблице Панели Администратора',
                'activity' => true,
                'sort' => 0,
            ],
            [
