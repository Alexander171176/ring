...
class RubricSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $defaultViews = 0;
        $defaultImage = 'rubric_images/default-image.png';
        $defaultSeoTitle = 'default';
        $defaultSeoAlt = 'default';

        $rubrics = [
            [
                'sort' => 1, 'activity' => 1, 'icon' => $defaultIcon, 'views' => $defaultViews, 'image_url' => $defaultImage,
                'translations' => [
            ...
            [
                'sort' => 2, 'activity' => 1, 'icon' => $defaultIcon, 'views' => $defaultViews, 'image_url' => $defaultImage,
                'translations' => [
            ...
            [
                'sort' => 3, 'activity' => 1, 'icon' => $defaultIcon, 'views' => $defaultViews, 'image_url' => $defaultImage,
                'translations' => [
