import { onMounted, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, createCommentVNode, withDirectives, vModelSelect, useSSRContext } from "vue";
...
import { _ as _sfc_main$6, a as _sfc_main$8, b as _sfc_main$e } from "./InputText-D7S11vGR.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      embed_code: "",
      source_type: "local",
      // тип источника (по умолчанию local)
      duration: "",
      // длительность видео (в секундах)
      external_video_id: "",
      // идентификатор видео из внешнего сервиса
      video_url: "",
      // URL файла локального видео (если применяется)
      video_file: null
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Videos/Create.vue");
