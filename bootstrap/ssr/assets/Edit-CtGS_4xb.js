...
import { _ as _sfc_main$6, a as _sfc_main$8, b as _sfc_main$d } from "./InputText-D7S11vGR.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      name: (_a = props.tag) == null ? void 0 : _a.name,
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editTag"))} ID:${ssrInterpolate(props.tag.id)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editTag")) + " ID:" + toDisplayString(props.tag.id), 1)
                  ];
                }
              }),
              _: 1
