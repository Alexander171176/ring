import { ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, useSSRContext } from "vue";
...
import { _ as _sfc_main$4, a as _sfc_main$7, b as _sfc_main$b } from "./InputText-D7S11vGR.js";
...
import { _ as _sfc_main$a } from "./MultiImageUpload-CLyjsinp.js";
import { _ as _sfc_main$9 } from "./MultiImageEdit-DdDeFkMb.js";
/* empty css                                                                      */
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const existingImages = ref(
      (props.banner.images || []).filter((img) => img.url).map((img) => ({
        id: img.id,
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editBanner"))}: ${ssrInterpolate(props.banner.title)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editBanner")) + ": " + toDisplayString(props.banner.title), 1)
                  ];
                }
              }),
              _: 1
