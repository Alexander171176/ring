...
import { _ as _sfc_main$a } from "./ConfirmationModal-BoRLvAc4.js";
import { _ as _sfc_main$b } from "./DangerButton-CMZ45e4N.js";
import { _ as _sfc_main$8 } from "./DialogModal-CdysBQnD.js";
...
import { _ as _sfc_main$9 } from "./SecondaryButton-CkEpBeGd.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.userPermissions.canAddTeamMembers) {
        ...
        _push(ssrRenderComponent(_sfc_main$1, { onSubmitted: addTeamMember }, {
          title: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("addTeamMember"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(t)("addTeamMember")), 1)
              ];
            }
          }),
          description: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("addTeamMemberDescription"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(t)("addTeamMemberDescription")), 1)
              ];
            }
          }),
          form: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="col-span-6"${_scopeId}><div class="max-w-xl font-semibold text-lg text-indigo-800 dark:text-slate-300"${_scopeId}>${ssrInterpolate(unref(t)("addTeamMemberEmailPrompt"))}</div></div><div class="col-span-6 sm:col-span-4"${_scopeId}>`);
              ...
              if (__props.availableRoles.length > 0) {
                ...
                ssrRenderList(__props.availableRoles, (role, i) => {
                  ...
                  }, "relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"])}"${_scopeId}><div class="${ssrRenderClass({
                    "opacity-50": unref(addTeamMemberForm).role && unref(addTeamMemberForm).role != role.key
                  })}"${_scopeId}><div class="flex items-center"${_scopeId}><div class="${ssrRenderClass([{ "font-semibold": unref(addTeamMemberForm).role == role.key }, "font-semibold text-xl text-pink-400"])}"${_scopeId}>${ssrInterpolate(role.name)}</div>`);
                  ...
                  _push2(`</div><div class="mt-2 italic text-lg text-gray-900 dark:text-slate-50 text-start"${_scopeId}>${ssrInterpolate(role.description)}</div></div></button>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              return [
                createVNode("div", { class: "col-span-6" }, [
                  createVNode("div", { class: "max-w-xl font-semibold text-lg text-indigo-800 dark:text-slate-300" }, toDisplayString(unref(t)("addTeamMemberEmailPrompt")), 1)
                ]),
                      ...
                      return openBlock(), createBlock("button", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("div", { class: "flex items-center" }, [
                            createVNode("div", {
                              class: ["font-semibold text-xl text-pink-400", { "font-semibold": unref(addTeamMemberForm).role == role.key }]
                          ...
                          createVNode("div", { class: "mt-2 italic text-lg text-gray-900 dark:text-slate-50 text-start" }, toDisplayString(role.description), 1)
                        ], 2)
                      ], 10, ["onClick"]);
                    }), 128))
                  ])
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$2, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(unref(t)("added"))}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(unref(t)("added")), 1)
                    ];
                  }
                }),
                _: 1
      ...
      if (__props.team.team_invitations.length > 0 && __props.userPermissions.canAddTeamMembers) {
        ...
        _push(ssrRenderComponent(_sfc_main$7, { class: "mt-10 sm:mt-0" }, {
          title: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("pendingInvitations"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(t)("pendingInvitations")), 1)
              ];
            }
          }),
          description: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("pendingInvitationsDescription"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(t)("pendingInvitationsDescription")), 1)
              ];
            }
          }),
            ...
            if (_push2) {
              ...
              ssrRenderList(__props.team.team_invitations, (invitation) => {
                ...
                if (__props.userPermissions.canRemoveTeamMembers) {
                  _push2(`<button class="cursor-pointer ms-6 text-sm text-red-500 focus:outline-none"${_scopeId}>${ssrInterpolate(unref(t)("cancel"))}</button>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.team.team_invitations, (invitation) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center" }, [
                        ...
                        }, toDisplayString(unref(t)("cancel")), 9, ["onClick"])) : createCommentVNode("", true)
                      ])
                    ]);
                  }), 128))
                ])
      ...
      if (__props.team.users.length > 0) {
        ...
        _push(ssrRenderComponent(_sfc_main$7, { class: "mt-10 sm:mt-0" }, {
          title: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("teamMembers"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(t)("teamMembers")), 1)
              ];
            }
          }),
          description: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(t)("teamMembersDescription"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(t)("teamMembersDescription")), 1)
              ];
            }
          }),
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(__props.team.users, (user) => {
                ...
                if (_ctx.$page.props.auth.user.id === user.id) {
                  _push2(`<button class="cursor-pointer ms-6 text-sm text-red-500"${_scopeId}>${ssrInterpolate(unref(t)("leave"))}</button>`);
                } else if (__props.userPermissions.canRemoveTeamMembers) {
                  _push2(`<button class="cursor-pointer ms-6 text-sm text-red-500"${_scopeId}>${ssrInterpolate(unref(t)("remove"))}</button>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.team.users, (user) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center" }, [
                        ...
                        }, toDisplayString(unref(t)("leave")), 1)) : __props.userPermissions.canRemoveTeamMembers ? (openBlock(), createBlock("button", {
                          key: 3,
                          class: "cursor-pointer ms-6 text-sm text-red-500",
                          onClick: ($event) => confirmTeamMemberRemoval(user)
                        }, toDisplayString(unref(t)("remove")), 9, ["onClick"])) : createCommentVNode("", true)
                      ])
                    ]);
                  }), 128))
                ])
      ...
      _push(ssrRenderComponent(_sfc_main$8, {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("manageRoles"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(t)("manageRoles")), 1)
            ];
          }
        }),
        content: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(_sfc_main$a, {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("leaveTeam"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(t)("leaveTeam")), 1)
            ];
          }
        }),
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("leaveTeamConfirmation"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(t)("leaveTeamConfirmation")), 1)
            ];
          }
        }),
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("leave"))}`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(_sfc_main$a, {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("removeTeamMember"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(t)("removeTeamMember")), 1)
            ];
          }
        }),
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t)("removeTeamMemberConfirmation"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(t)("removeTeamMemberConfirmation")), 1)
            ];
          }
        }),
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("remove"))}`);
                } else {
                  return [
