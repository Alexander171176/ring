import { onMounted, ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, createCommentVNode, withDirectives, vModelSelect, useSSRContext } from "vue";
...
import { _ as _sfc_main$6, a as _sfc_main$8, b as _sfc_main$g } from "./InputText-D7S11vGR.js";
...
import { _ as _sfc_main$f } from "./MultiImageUpload-CLyjsinp.js";
import { _ as _sfc_main$e } from "./MultiImageEdit-DdDeFkMb.js";
import { _ as _sfc_main$b } from "./VideoSourceFields-B01NHdro.js";
/* empty css                                                                      */
...
const _sfc_main = {
  ...
  props: {
    ...
    sections: Array,
    articles: Array,
    related_videos: { type: Array, default: () => [] }
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      published_at: props.video.published_at ? new Date(props.video.published_at).toISOString().split("T")[0] : "",
    ...
    const existingImages = ref(
      (props.video.images || []).filter((img) => img.url).map((img) => ({
        id: img.id,
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editVideo"))}: ${ssrInterpolate(props.video.title)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editVideo")) + ": " + toDisplayString(props.video.title), 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              for: "articles",
              value: unref(t)("articles"),
              class: "mb-1"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(unref(VueMultiselect), {
              modelValue: unref(form).articles,
              "onUpdate:modelValue": ($event) => unref(form).articles = $event,
              options: __props.articles,
              multiple: true,
              "close-on-select": true,
              placeholder: unref(t)("select"),
              label: "title",
            ...
            _push2(`</div><div class="flex flex-col lg:flex-row items-center mb-2 lg:mb-0 flex-1 justify-between"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              for: "duration",
            ...
            if (unref(form).errors.embed_code) {
              _push2(ssrRenderComponent(_sfc_main$5, {
                class: "mt-2",
            ...
            if (unref(form).errors.external_video_id) {
              _push2(ssrRenderComponent(_sfc_main$5, {
                class: "mt-2",
            ...
            _push2(ssrRenderComponent(unref(VueMultiselect), {
              ...
              options: __props.related_videos,
              multiple: true,
              "close-on-select": true,
              placeholder: unref(t)("select"),
              label: "title",
            ...
            _push2(`</div><div class="mb-3 flex flex-col sm:flex-row justify-between"${_scopeId}><div class="flex flex-row items-center mb-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              for: "views",
              value: unref(t)("views"),
              class: "mr-3"
                ...
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "mb-3 flex flex-col lg:flex-row lg:justify-between lg:space-x-4" }, [
                      ...
                      createVNode("div", { class: "flex flex-col lg:flex-row items-center mb-2 lg:mb-0 flex-1 justify-between" }, [
                        createVNode(_sfc_main$6, {
                          for: "duration",
                          value: unref(t)("duration"),
                          class: "mb-1 lg:mb-0 lg:mr-2"
                    ...
                    createVNode("div", { class: "flex flex-col items-start" }, [
                      ...
                      unref(form).errors.embed_code ? (openBlock(), createBlock(_sfc_main$5, {
                        key: 0,
                        class: "mt-2",
                        message: unref(form).errors.embed_code
                      }, null, 8, ["message"])) : createCommentVNode("", true),
                      unref(form).errors.external_video_id ? (openBlock(), createBlock(_sfc_main$5, {
                        key: 1,
                        class: "mt-2",
                        message: unref(form).errors.external_video_id
                      }, null, 8, ["message"])) : createCommentVNode("", true)
                    ...
                    createVNode("div", { class: "mb-3 flex flex-col sm:flex-row justify-between" }, [
                      createVNode("div", { class: "flex flex-row items-center mb-2" }, [
                        createVNode(_sfc_main$6, {
                          for: "views",
                          value: unref(t)("views"),
                          class: "mr-3"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Videos/Edit.vue");
