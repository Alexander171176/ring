  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.users.length > 0) {
        _push(`<table class="table-auto w-full text-slate-700 dark:text-slate-100"><thead class="text-sm font-semibold uppercase bg-slate-200 dark:bg-cyan-900 border border-solid border-gray-300 dark:border-gray-700"><tr><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-left">${ssrInterpolate(unref(t)("name"))}</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-left">${ssrInterpolate(unref(t)("email"))}</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-left">${ssrInterpolate(unref(t)("roles"))}</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-end">${ssrInterpolate(unref(t)("actions"))}</div></th></tr></thead><tbody><!--[-->`);
        ssrRenderList(__props.users.filter((u) => u.id !== 1), (user) => {
          _push(`<tr class="text-sm font-semibold border-b-2"><td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap text-teal-600 dark:text-violet-200 hover:bg-slate-100 dark:hover:bg-cyan-800"><div class="text-left">${ssrInterpolate(user.name)}</div></td><td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap text-blue-600 dark:text-blue-200 hover:bg-slate-100 dark:hover:bg-cyan-800"><div class="text-left">${ssrInterpolate(user.email)}</div></td><td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap"><div class="flex flex-wrap gap-1"><!--[-->`);
          ssrRenderList(user.roles, (role) => {
            _push(`<span class="px-1 py-0 bg-slate-100 dark:bg-slate-800 border border-dashed border-gray-400 text-orange-500 dark:text-orange-200 text-xs">${ssrInterpolate(role.name)}</span>`);
          });
          _push(`<!--]-->`);
          ...
          _push(ssrRenderComponent(_sfc_main$4, {
            onDelete: ($event) => _ctx.$emit("delete", user.id)
          }, null, _parent));
          _push(`</div></td></tr>`);
        });
        _push(`<!--]--></tbody></table>`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/User/Table/UserTable.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/User/Sort/SortSelect.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    computed(() => Math.ceil(filteredUsers.value.length / itemsPerPage.value));
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("users"))}`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` ${ssrInterpolate(unref(t)("addUser"))}`);
                } else {
                  return [
                    createTextVNode(" " + toDisplayString(unref(t)("addUser")), 1)
                  ];
                }
              }),
              _: 1
            ...
            if (__props.usersCount) {
              _push2(ssrRenderComponent(_sfc_main$6, {
                ...
                placeholder: unref(t)("searchByNameOrEmail")
            ...
            if (__props.usersCount) {
              _push2(ssrRenderComponent(_sfc_main$7, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(__props.usersCount - 1)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(__props.usersCount - 1), 1)
                    ];
                  }
                }),
                _: 1
            ...
            return [
              createVNode("div", { class: "px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto" }, [
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 overflow-hidden shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  __props.usersCount ? (openBlock(), createBlock(_sfc_main$6, {
                    key: 0,
                    modelValue: searchQuery.value,
                    "onUpdate:modelValue": ($event) => searchQuery.value = $event,
                    placeholder: unref(t)("searchByNameOrEmail")
                  }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder"])) : createCommentVNode("", true),
                  __props.usersCount ? (openBlock(), createBlock(_sfc_main$7, { key: 1 }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(__props.usersCount - 1), 1)
                    ]),
                    _: 1
