...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      _method: "PUT",
      sort: ((_a = props.setting) == null ? void 0 : _a.sort) ?? 0,
      type: ((_b = props.setting) == null ? void 0 : _b.type) ?? "",
      option: ((_c = props.setting) == null ? void 0 : _c.option) ?? "",
      value: ((_d = props.setting) == null ? void 0 : _d.value) ?? "",
      constant: ((_e = props.setting) == null ? void 0 : _e.constant) ?? "",
      category: ((_f = props.setting) == null ? void 0 : _f.category) ?? "",
      description: ((_g = props.setting) == null ? void 0 : _g.description) ?? "",
      activity: Boolean(((_h = props.setting) == null ? void 0 : _h.activity) ?? false)
    });
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editParameter"))} ID:${ssrInterpolate((_a2 = props.setting) == null ? void 0 : _a2.id)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editParameter")) + " ID:" + toDisplayString((_b2 = props.setting) == null ? void 0 : _b2.id), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(TitlePage, null, {
                default: withCtx(() => {
                  var _a2;
                  return [
                    createTextVNode(toDisplayString(unref(t)("editParameter")) + " ID:" + toDisplayString((_a2 = props.setting) == null ? void 0 : _a2.id), 1)
                  ];
                }),
                _: 1
              })
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Parameters/Edit.vue");
