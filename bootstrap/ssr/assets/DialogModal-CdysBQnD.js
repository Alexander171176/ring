    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-6 py-4"${_scopeId}><div class="text-xl font-medium text-gray-900"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "title", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div><div class="mt-4 font-semibold text-lg text-violet-600"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "px-6 py-4" }, [
                createVNode("div", { class: "text-xl font-medium text-gray-900" }, [
