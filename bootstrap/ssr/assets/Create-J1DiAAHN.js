import { onMounted, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, useSSRContext } from "vue";
...
import { _ as _sfc_main$c } from "./MultiImageUpload-CLyjsinp.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("createArticle"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("createArticle")), 1)
                  ];
                }
              }),
              _: 1
