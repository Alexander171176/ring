...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      title: (_a = props.category) == null ? void 0 : _a.title,
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editCategory"))} ID:${ssrInterpolate(props.category.id)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editCategory")) + " ID:" + toDisplayString(props.category.id), 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              href: _ctx.route("admin.categories.index", { locale: props.category.locale })
            }, {
