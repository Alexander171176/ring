      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({ title: "package.json" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.package, (value, key) => {
              _push2(`<div class="mb-4"${_scopeId}><div class="font-semibold text-orange-500 dark:text-orange-300"${_scopeId}>${ssrInterpolate(key)}</div>`);
              ...
              createVNode("div", { class: "px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto" }, [
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 overflow-hidden shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  createVNode("div", { class: "overflow-x-auto border rounded-md shadow p-4 bg-white dark:bg-gray-900 text-sm" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.package, (value, key) => {
                      return openBlock(), createBlock("div", {
                        key,
                        class: "mb-4"
                      }, [
                        createVNode("div", { class: "font-semibold text-orange-500 dark:text-orange-300" }, toDisplayString(key), 1),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Systems/PackageInfoPage.vue");
