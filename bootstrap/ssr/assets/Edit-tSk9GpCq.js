          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editPermission"))} ID:${ssrInterpolate(props.permission.id)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editPermission")) + " ID:" + toDisplayString(props.permission.id), 1)
                  ];
                }
              }),
              _: 1
