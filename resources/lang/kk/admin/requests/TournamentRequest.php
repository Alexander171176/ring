...
return [
    ...
    'left.boolean' => 'Сол жақ бағандағы өріс логикалық мән болуы керек.',
    'main.boolean' => 'Main жасайтын өріс логикалық мән болуы керек.',
    'right.boolean' => 'Оң жақ бағандағы өріс логикалық мән болуы керек.',
    ...
    'videos.*.id.required_with' => 'Бейне идентификаторы қажет.',
    'videos.*.id.exists' => 'Жоқ бейне таңдалды (ID: :value).',
];
