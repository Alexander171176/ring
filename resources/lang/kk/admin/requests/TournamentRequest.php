...
return [
    ...
    'url.required' => 'Турнир URL мекенжайы қажет.',
    'url.string' => 'Турнир URL мекенжайы жол болуы керек.',
    'url.max' => 'Турнир URL мекенжайы 500 таңбадан аспауы керек.',
    'url.regex' => 'URL тек латын әріптерін, сандарын және сызықшаларды қамтуы керек.',
    'url.unique' => 'Осы URL мекенжайы бар турнир бұрыннан бар.',
