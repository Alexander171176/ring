...
import TournamentInfoBlock from "@/Components/Public/Default/Tournament/TournamentInfoBlock.vue";
        ...
        <div class="flex flex-col w-full bg-slate-50 dark:bg-blue-950">
            ...
            <div class="flex flex-col bg-slate-50 dark:bg-blue-950 w-full p-8">
                ...
                <div v-if="!isStarted" class="w-full text-center mt-4">
                    <div v-if="countdown" class="flex justify-center gap-1 flex-wrap">
                        <div class="flex flex-col items-center w-14 h-14 rounded-lg
