...
import DirectoryStructure from '@/Components/Admin/Component/DirectoryStructure.vue'; // Импортируем новый компонент
...
const saveChanges = async () => {
    router.post(route('builders.save'), {
    ...
    <AdminLayout :title="t('builders')">
        ...
        <div class="bg-gray-100 dark:bg-slate-900 bg-opacity-90 dark:bg-opacity-90
            ...
            <div v-if="selectedFile"
                ...
                <h2 class="mb-4 text-sm font-semibold text-gray-900">Редактирование файла: {{ selectedFile }}</h2>
