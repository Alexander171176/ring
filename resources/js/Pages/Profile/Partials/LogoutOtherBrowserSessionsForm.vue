...
<template>
    <ActionSection>
        <template #title>{{ t('browserSessionTitle') }}</template>
        ...
        <template #content>
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="font-semibold text-lg text-gray-900 dark:text-slate-300">
                                ...
                                > - {{ t('thisDevice') }}</span
                                >
                                <span v-else>{{ t('lastActive') }} {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">{{ t('logoutOtherSessionsButton') }}</PrimaryButton>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                <template #title>{{ t('logoutOtherSessionsButton') }}</template>
