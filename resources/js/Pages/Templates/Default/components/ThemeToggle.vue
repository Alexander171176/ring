...
<template>
    <div>
        ...
        <label
            class="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-50 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full"
            for="light-switch">
            ...
            <span class="sr-only">{{ t('toggleDarkMode') }}</span>
        </label>
    </div>
</template>
