...
import PageMenu from '@/Pages/Templates/Default/components/PageMenu.vue';
            ...
            <div class="max-w-full mx-auto px-4 sm:px-0">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center justify-center ml-4">
                        ...
                        <PageMenu :isOpen="showingNavigationDropdown" class="hidden md:block"/>
                    ...
                    <div class="sm:flex sm:items-center sm:ms-6 sm:mr-4">
