...
watch(() => props.title, (newTitle) => {
    updateMetaTags(newTitle);
});
</script>

<template>
    <DefaultLayout :title="t('welcome')" :can-login="props.canLogin" :can-register="props.canRegister"
                   :laravelVersion="props.laravelVersion" :phpVersion="props.phpVersion">
        <template #header>
            <TitlePage>
                {{ t('welcome') }}
            </TitlePage>
            ...
            <div class="max-w-7xl mt-16 mx-auto p-6 lg:p-8">
                <div class="mt-16">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <Plugin :pluginName="'SamplePlugin'" :id="1" />
                        <Plugin :pluginName="'SamplePlugin'" :id="2" />
                        <Plugin :pluginName="'SamplePlugin'" :id="3" />
                        <div
