<!-- Компонент: ScheduledTournaments.vue -->
<script setup>
...
<template>
    <div v-if="scheduledTournaments.length" class="mt-10">
                ...
                <Link :href="`/tournaments/${tournament.id}`">
                    ...
                    <template v-if="tournament.images?.length">
                        <div class="relative w-full h-80 overflow-hidden">
                            ...
                            <!-- Инфо наложение -->
                            <div class="absolute bottom-0 left-0 right-0 bg-black/60 text-white text-center p-3">
                    ...
                    <div v-else
                         class="relative bg-gray-300 rounded-md overflow-hidden
                                border-2 border-blue-800 dark:border-slate-400 p-4">
