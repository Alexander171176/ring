...
<template>
    <div
        ...
        <!-- Точки -->
        <div class="absolute top-3 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10">
            <span
        ...
        <transition name="fade" mode="out-in">
            <div
                ...
                class="shadow-md bg-white dark:bg-slate-800 overflow-hidden"
            >
                <div class="relative">
                    <img
                        ...
                        class="w-full h-auto object-cover border-2 border-gray-400 transition rounded-xl"
                    />
