...
const totalViews = computed(() => props.articles.reduce((acc, article) => acc + article.views, 0));
...
onMounted(() => {
    // console.log('ArticleBarChart05 data:', articleChartData.value)
    createChart()
})
    ...
    <div class="px-5 py-3">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex items-center">
                <div class="text-3xl font-bold text-slate-800 mr-2">{{ totalViews }}</div>
