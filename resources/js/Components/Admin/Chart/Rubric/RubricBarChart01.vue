        ...
        datasets: [
            {
                ...
                backgroundColor: 'rgba(255, 159, 64, 0.7)', // Новый цвет
                borderColor: 'rgba(255, 159, 64, 1)', // Новый цвет
                borderWidth: 1,
            },
            {
                label: 'Дата изменения',
                data: aggregatedData(updatedData),
                backgroundColor: 'rgba(54, 162, 235, 0.7)', // Новый цвет
                borderColor: 'rgba(54, 162, 235, 1)', // Новый цвет
                borderWidth: 1,
            },
        ],
    };
