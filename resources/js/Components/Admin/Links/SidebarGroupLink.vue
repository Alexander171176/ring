...
<template>
    ...
    <SidebarLink :href="route('admin.phpinfo.index')"
                 :active="route().current('phpinfo.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                <!-- Первая шестерёнка -->
    ...
    <SidebarLink :href="route('admin.composer.index')"
                 :active="route().current('composer.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                <!-- Первая шестерёнка -->
    ...
    <SidebarLink :href="route('admin.package.index')"
    ...
    <SidebarLink :href="route('admin.env.index')"
                 :active="route().current('env.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                <!-- Первая шестерёнка -->
